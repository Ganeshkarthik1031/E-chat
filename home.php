  ...
  upgrade();
	...
	var SpeechRecognition = window.SpeechRecognition || window.webkitSpeechRecognition;
		...
		recognition.onresult = function(event) { 
		    ...
		    document.getElementById('txtarea').value = saidText;
...
<center>
	<div id="main">
		...
		<table width="80%" align="center">
			<tr>
				<td align="right"><textarea id="txtarea" name="txtarea" required></textarea></td><td width="">
				<input type="submit" value="record" id="send"  onclick='startRecording();'></div></td><td>
				<input type="submit" value=">>" id="send"></div></td>
			</tr>
		</table>
		</form>
	</div>
